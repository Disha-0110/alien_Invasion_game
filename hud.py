...
class HUD:
    '''A class to manage and siplay on screen game statistics'''
    def __init__(self, game):
        '''initialize HUD attibutes such as score, level and lives'''
        self.game = game
        self.settings = game.settings
        self.screen = game.screen
        self.boundaries = game.screen.get_rect()
        self.game_stats = game.game_stats
        #font for rendering HUD text
    ...
    def update_scores(self):
        '''update score, max score and high score'''
        self._update_score()
    ...
    def _update_max_score(self):
        '''render the session max score into an image'''
    ...
    def _update_hi_score(self):
        '''render the saved high score into an image'''
    ...
    def update_level(self):
        '''render the current  level into an image'''
    ...
    def _draw_lives(self):
        '''draw ship icons to represent remaining lives'''
    ...
    def draw(self):
        '''draw all HUD element to the screen'''
